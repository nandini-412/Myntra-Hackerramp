    ...
    <div className="container">
      <div className="row">
        <div className="col-md-8 py-5">
          <div className="latestPostsHeading border-bottom d-flex">
            <p className="col-md-3 d-flex align-items-center justify-content-center py-2 h5 latestpost">
              Latest Posts
            </p>
          </div>
          <div className="row">
            <div className="col-md-12 my-5">
              ...
              <Link to="/posts" className="btn btn-block" id="allpost">
                All Posts
              </Link>
            </div>
          </div>
