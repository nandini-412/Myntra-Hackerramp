...
const AddPost = () => {
  ...
  return (
    <div className="container fontedit">
      <div className="row">
        ...
        <div className="col-md-12 mb-3">
          <h2 className="display-3 text-center" id="headingedit">Add Post</h2>
        </div>
        <div className="col-md-6 mx-auto mb-5 shadow p-5">
          {progress ? (
            progress !== 100 ? (
              <div className="mx-auto p-5">
                <h1 className="text-center my-2" id="headingedit">
              ...
              <div className="mx-auto p-5   text-center ">
                ...
                <h3 className="text-center my-2" id="headingedit">Post Uploaded successfully</h3>
                <Link
