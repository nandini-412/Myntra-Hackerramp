            ...
            <div className="d-flex align-items-center justify-content-between">
              ...
              <div className="d-flex col-md-4 align-items-center justify-content-end">
                {currentPost.post.category.split(",").map((category, id) => (
                  <p key={id} className="mx-2 px-2 py-1" id="tags">
                    {category.trim()}
                  </p>
                ))}
              </div>
            ...
            <div className="d-flex">
              ...
              <div className="comments py-5 mt-2 w-50">
                {!isLoggedIn ? (
                  <form className="px-5" onSubmit={makeComment}>
                    ...
                    <div className="form-group">
                      <button type="submit" className="btn my-2" id="addcomment">
                        Add Query
                      </button>
                    </div>
                  </form>
                ...
                {currentPost.post.comments.length > 0 ? (
                  currentPost.post.comments.map((comment, id) => (
                    <>
                      ...
                      >
                        <div className="d-flex align-items-center justify-content-between profile">
                          <div className="col-md-6 d-flex">
                            <div className="col-md-3 rounded-circle py-3 text-center bg-dark text-white text-uppercase d-flex align-items-center justify-content-center">
                              { (comment.name.split(" ").length>0 && comment.name.split(" ").length < 2)
                          ...
                          {comment.admin ? (
                            comment.postOwner ? (
                              <div className="d-flex col-md-4">
                                <p className="small py-1 px-2 ml-auto" id="own">
                                  Owner
                                </p>
                                <p className="small py-1 px-2 ml-2" id="own">
                                  Admin
                                </p>
                              </div>
                            ) : (
                              <p className="small py-1 px-2" id="own">
                                Admin
                              </p>
                            )
                          ) : null}
                        ...
                        <p
                          className="text-center mx-3 py-2 px-3"
                          id="addcomment"
                          style={{ width: "100px"}}
                        >
                          Replies
                  ...
                  <h2 className="card-heading text-center my-3">No queries</h2>
                )}
              </div>
            </div>
          </div>
